 ...
 */
namespace ElementskitVendor\Composer;

use ElementskitVendor\Composer\Autoload\ClassLoader;
use ElementskitVendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ElementskitVendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
