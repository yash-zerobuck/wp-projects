...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('ElementskitVendor\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['ElementskitVendor\\Google\\Client' => 'Google_Client', 'ElementskitVendor\\Google\\Service' => 'Google_Service', 'ElementskitVendor\\Google\\Service\\Resource' => 'Google_Service_Resource', 'ElementskitVendor\\Google\\Model' => 'Google_Model', 'ElementskitVendor\\Google\\Collection' => 'Google_Collection'];
