...
class ElementsKit_Widget_Facebook_Review extends Widget_Base {
	...
	protected function get_slideshow_column($settings, $slides_to_show, $slides_to_scroll) {
		$responsive = [];
		$slides_to_show_tablet = esc_attr( isset($settings[$slides_to_show . "_tablet"]) ? $settings[$slides_to_show . "_tablet"] : '' );
		$slides_to_show_mobile = esc_attr( isset($settings[$slides_to_show . "_mobile"]) ? $settings[$slides_to_show . "_mobile"] : '' );
		$slides_to_show_desktop = esc_attr($settings[$slides_to_show]);

		$slides_to_scroll_tablet = esc_attr( isset($settings[$slides_to_scroll . "_tablet"]) ? $settings[$slides_to_scroll . "_tablet"] : '' );
		$slides_to_scroll_mobile = esc_attr( isset($settings[$slides_to_scroll . "_mobile"]) ? $settings[$slides_to_scroll . "_mobile"] : '' );
	...
	private function controls_section_layout() {
		...
		$this->add_responsive_control('ekit_review_grid_column_gap', [
			                                                           ...
			                                                           'selectors'      => [
				                                                           '{{WRAPPER}} .ekit-review-cards-facebok.ekit-review-cards-grid .row'       =>
					                                                           'margin-right: calc(-{{SIZE}}{{UNIT}} / 2);margin-left: calc(-{{SIZE}}{{UNIT}} / 2);',
				                                                           '{{WRAPPER}} .ekit-review-cards-facebok.ekit-review-cards-grid .row > div' =>
	...
	private function controls_section_slideshow() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'       => [
					'{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-slide' =>
						'margin-right: {{SIZE}}{{UNIT}} !important;margin-left: {{SIZE}}{{UNIT}} !important;',
					'{{WRAPPER}} .ekit-review-slider-wrapper-facebook'              => 'margin: 0 -{{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	private function controls_section_reviewer_card_stars() {
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
					...
					{{WRAPPER}} .ekit-review-card-facebook .ekit-review-card--stars .icon',
			                                    ]
		);
	...
	private function controls_section_overview_stars() {
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(), [
				                                    ...
				                                    'selector' =>
					                                    '{{WRAPPER}} .ekit-review-card-facebook.ekit-review-card-overview .ekit-review-card--stars,
					{{WRAPPER}} .ekit-review-card-facebook.ekit-review-card-overview .ekit-review-card--stars .icon',
			                                    ]
		);
	...
	private function controls_section_dots() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-dots' =>
						'bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-dots li button' =>
						'width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-dots li'        =>
						'width: auto;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-dots li:not(:last-child)' =>
						'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Background', 'elementskit'),
				'types'    => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-dots li button',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__('Background', 'elementskit'),
				'types'    => ['classic', 'gradient'],
				'selector' => '{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-dots li.slick-active button',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ekit-review-slider-wrapper-facebook .slick-dots li.slick-active button' =>
						'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
            ...
            <div class="ekit-review-wrapper ekit-review-wrapper-facebook">
				...
				if($ekit_review_styles == 'default') :
					...
					if(!empty($reviews->data)):
						...
						?>
                        <div class="ekit-review-cards ekit-review-cards-facebok <?php echo "ekit-review-cards-" . esc_attr($ekit_review_card_appearance); ?>">
							<?php
							if(isset($ekit_review_styles) && $ekit_review_styles == 'slideshow'):
								...
								$data_attrs = "data-slidestoshow='" . esc_attr($ekit_review_slideshow_slides_to_show) . "'";
								$data_attrs .= "data-slidestoscroll='" . esc_attr($ekit_review_slideshow_slides_to_scroll) . "'";
								$data_attrs .= "data-speed='" . esc_attr($ekit_review_slideshow_speed) . "'";
								$data_attrs .= "data-autoplay='" . esc_attr($ekit_review_slideshow_autoplay) . "'";

								// Arrows
								$data_attrs .= "data-showarrow='" . esc_attr($ekit_review_slideshow_show_arrow) . "'";
								$data_attrs .= "data-prevarrow='" . esc_attr($arrowLeftIcon) . "'";
								$data_attrs .= "data-nextarrow='" . esc_attr($arrowRightIcon) . "'";

								$data_attrs .= "data-showdot='" . esc_attr($ekit_review_slideshow_show_dot) . "'";
								$data_attrs .= "data-pauseonhover='" . esc_attr($ekit_review_slideshow_pause_on_hover) . "'";
								$data_attrs .= "data-carousel_loop='" . esc_attr($carousel_loop) . "'";
								...
								?>
                                <!-- Start slideshow -->
                                <div class="ekit-review-slider-wrapper ekit-review-slider-wrapper-facebook slick-slider arrow_inside <?php echo !empty($settings['ekit_review_slideshow_show_dot']) ? 'slick-dotted' : '' ?>"
									<?php echo \ElementsKit_Lite\Utils::render($data_attrs); ?>
                                >
