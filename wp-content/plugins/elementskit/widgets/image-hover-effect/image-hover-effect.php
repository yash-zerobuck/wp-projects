...
class ElementsKit_Widget_Image_Hover_Effect extends Widget_Base {
	...
	function image_link($ekit_hover_link) {
		 if (!empty($ekit_hover_link['url'])) {
			...
			echo sprintf('<a class="ekit_image_caption_link" %1$s></a>', $this->get_render_attribute_string('ekit_hover_link'));
		}
	}
			...
			<div class="ekit_<?php echo esc_attr($image_hover_class); ?>">
				...
				<div class="ekit_image_caption <?php echo esc_attr($hover_text_class.' '.$hoverAnimatedClass); ?>">
					...
					<?php if($ekit_hover_image_btn == 'yes'): ?>	
						<a class="elementskit-btn ekit_image_caption_button <?php echo esc_attr($button_show.' '.$button_stable_switch.' '.$entranceAnimatedClass); ?>" data-settings="<?php echo esc_attr(json_encode($entranceAnimationData)); ?>" <?php echo esc_attr($this->get_render_attribute_string( 'ekit_image_button_link' )); ?>>
			...
			<div class="ekit_image_hover">
				<div class="ekit_<?php echo esc_attr($image_hover_class); ?>">
					...
					<div class="ekit_image_caption <?php echo esc_attr($hover_text_class.' '.$hoverAnimatedClass); ?>" >
						...
						<?php if($ekit_hover_image_btn == 'yes'): ?>	
							<a class="elementskit-btn ekit_image_caption_button <?php echo esc_attr($button_show.' '.$button_stable_switch.' '.$entranceAnimatedClass); ?>" <?php echo esc_attr($this->get_render_attribute_string( 'ekit_image_button_link' )); ?> data-settings="<?php echo esc_attr(json_encode($entranceAnimationData));?>">
								<?php echo esc_html($ekit_image_button_text); ?>
							</a>		
						<?php endif; ?>		
					</div>			
