   ...
   use \ElementsKit_Lite\Widgets\Widget_Notice;
    ...
    protected function get_fancy_content($settings) {
        ...
        if(!empty($ekit_fancy_prefix_text)) : ?>
            <span class="ekit-fancy-prefix-text"><?php echo esc_html($ekit_fancy_prefix_text); ?></span>
        <?php endif;
        ...
        if(!empty($ekit_fancy_suffix_text)) : ?>
            <span class="ekit-fancy-suffix-text"><?php echo esc_html($ekit_fancy_suffix_text) ?></span>
        <?php endif;
